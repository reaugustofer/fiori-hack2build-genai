		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "HackBuild GenAI",
									"targetURL": "#numenitcomhack2buildgenai-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"numenitcomhack2buildgenai-display": {
								"semanticObject": "numenitcomhack2buildgenai",
								"action": "display",
								"description": "Hack2Build GenAI",
								"title": "HackBuild GenAI",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=numenit.com.hack2buildgenai",
									"url": sap.ui.require.toUrl("numenit/com/hack2buildgenai")
								}
							}
						}
					}
